...
const RegistrationForm = ({ onRegister, isLoading }) => {
  ...
  return (
    <div className="form_mainWrapper">
      <form className="form width500" onSubmit={handleSubmit}>
        <h2>Register</h2>
          ...
          <div className="form-contentWrapper">
            <div className="form-content">
              ...
              <input
                ...
                placeholder="Please enter happiest minds email..."
          ...
          <div className="form-contentWrapper">
            <div className="form-content">
              ...
              <textarea
                ...
                placeholder="Please enter address with contact details..."
                onChange={handleChange}
              ></textarea>
        ...
        <div className="buttonRegisterWrapper">
