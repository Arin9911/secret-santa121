...
import SantaImage from "../../../assets/files/Santa-1.png";
...
const Dashboard = ({ user, namesList, endpoint, Names_Get_Query }) => {
  ...
  useEffect(() => {
    // console.log("matchList.userEmail -", matchList.userEmail);
  ...
  return (
    <div id="main" className="mainWrapper">
      <div className="main">
        ...
        {/* {console.log("isUserRegistered -", isUserRegistered, wish)}
        {console.log("matchList?.secretSanta -", matchList?.secretSanta)}
        {console.log("randomNumber -", randomNumber)} */}
        <div className="userWrapper">
          {matchList?.secretSanta ? (
            <div className="userDetailsWrapper marginBottom50">
              ...
              <span>
                {wish ||
                  `${matchList?.user} hasn't yet registered his wish. Please come back again...`}
                {/* {isUserRegistered
                  ? wish
                  : `${matchList?.user} hasn't yet registered his wish. Please come back again...`} */}
              </span>
          ...
          {matchList?.secretSanta ? (
            <div className="userDetailsWrapper marginTop50">
              ...
              <span>
                {address ||
                  `${matchList?.user} hasn't yet registered his address. Please come back again...`}
                {/* {isUserRegistered
                  ? address
                  : `${matchList?.user} hasn't yet registered his address. Please come back again...`} */}
              </span>
